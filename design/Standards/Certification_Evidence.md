...
[PoE 802.3bt Type 4: TPS2372-4 + TPS23730 + T2 ACF Transformer (Coilcraft POE600F-12LD, 60W, 12V) / USB-C 15V PD (STUSB4500) / Battery 11–16.4V]
  ...
  → TPS259807ONRGER eFuse (7A ILIM via R3=210Ω, 11.0V UVLO, 16.9V OVLO silicon-fixed, VQFN 4×4mm)
  → [Dual LMQ61460-Q1 5V/12A Buck] → 5V_MAIN → [LTC3350 + 6× Tecate SCMT32C156PRBA0 supercaps (33F/5.4V, 2S3P)]
  → 5V_MAIN bus
...
The eFuse (**TPS259807ONRGER**, 16.9V silicon-fixed OVLO, VQFN 4×4mm) is programmed via resistors (UVLO and ILIM) to the following thresholds:
...
| OVLO | **16.9V (silicon-fixed — TPS259807ONRGER)** | Highest available option on TPS25980. No external resistor required or present. Battery BMS must specify max 4.1V/cell (16.4V for 4S) to maintain 0.5V margin below OVLO rising threshold. See §3.2 Note on Battery Voltage. |
...
> **Note on Battery Voltage — OVLO Margin:** The TPS259807ONRGER has a silicon-fixed OVLO rising threshold of 16.9V typ (16.32V min / 17.31V max from datasheet). To maintain an engineering margin of
