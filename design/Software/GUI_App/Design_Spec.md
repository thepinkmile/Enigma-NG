...
* [ ] Implement I2C Wrapper for INA219 (Telemetry) — address 0x45 (rotor stack), 0x40 (power module); R_SHUNT=0.020Ω; CAL=0x0400; see Power_Management.md for driver code.
