...
- TPS25980 (TPS259804ONRGE) provides 7A ILIM (programmed via R3 = 210 Ω) and silicon-fixed 16.9V OVLO, which neatly caps the battery charge voltage window.

### OVLO Constraint

- eFuse OVLO is **16.9V silicon-fixed** (TPS259804ONRGE — no external programming resistor).
...
| Variant | OVLO | Status |
| --- | --- | --- |
| **TPS259804ONRGE** | **16.9V silicon-fixed** | ✅ **CORRECT — use this** |
