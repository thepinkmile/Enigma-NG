...
| Cable Harnesses | TBD | LINK-ALPHA, LINK-BETA, encoder IDC ribbons, reflector cable, fan cable | Each sub-assembly doc |
...
| 2 | Stator Board | Install ICs (CPLD, MCP23017 ×2, PCA9685, INA219), passives, connectors. Mount servo + SERVO_HOME switch. Bench-test I²C expanders before stack assembly. |
...
| 11 | Main Enclosure final assembly | Route all cable harnesses. Install panels. Fit fan. Secure EMI bonding. Final torque fasteners. |
