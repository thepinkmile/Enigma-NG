...
| J2 | Data Link Connector ⚠️ **Part number does not match description — connector spec requires re-review** | 26-pin 2×13 shrouded box header, 2.54mm | 2.54mm | TBD | TBD | TBD |
