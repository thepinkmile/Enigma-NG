...
| J7 | Extension Port IN header ⚠️ **Part number does not match description — connector spec requires re-review** | 16-pin 2×8 shrouded box | 2.54mm | TBD | TBD | TBD |
| J8 | Extension Port OUT header ⚠️ **Part number does not match description — connector spec requires re-review** | 16-pin 2×8 shrouded box | 2.54mm | TBD | TBD | TBD |
