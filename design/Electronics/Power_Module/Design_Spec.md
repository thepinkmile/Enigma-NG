...
> R10 changed to pull-down (10kΩ to GND) to ensure LDO is ON by default at power-up. Firmware must drive `ROTOR_EN` HIGH to disable the LDO (inverted vs the previous LDO's active-high enable logic).
