...
* **Rib Clearway ENIG Bond Zone:** Solder mask opening on L1 in the 2.0mm rib clearway gap between
...
* **3V3_ENIG pour:** The TPS75733KTTRG3 (TO-263 KTT, 5-pin 10.16×15.24mm) requires standard thermal pad soldering and local ground vias only —
  the ≥200mm² copper pour requirement of the previous high-dissipation LDO design is removed (P_diss ≤0.45W worst-case).
