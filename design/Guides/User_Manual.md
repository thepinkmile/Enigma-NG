...
The Power Module contains a bank of supercapacitors that store enough energy to power the system for ≥21.7 seconds after the input power is removed. This is by design — it provides a
...
3. **Supercap charging:** The LTC3350 supercap manager begins a controlled 0.5A soft-charge of the supercapacitor bank from the 5V_MAIN rail. This reduced charge rate keeps the system within power
   ...
   budget on all input sources. From a fully depleted state, the bank takes approximately **3 minutes** to reach full charge. Full hold-up protection (≥21.7 seconds) is available once
...
**Supercapacitors:** The Power Module contains six supercapacitor cells (25F each — Abracon
ADCR-T02R7SA256MB, arranged in a 2-series × 3-parallel configuration giving 37.5F at 5.4V,
managed by the LTC3350 supercap controller)
providing **≥24.8 seconds of hold-up** at a 5W shutdown load.This is sufficient for the operating system to perform a clean, ordered shutdown, preventing filesystem and memory corruption.
