...
| S003 | SBD | SW_CFG_APPLY | SPST NO momentary; panel-mount; positive tactile click; V >= 3.3V; I >= 50mA | TBD | TBD | TBD | TBD | RECHECK | Must fit enclosure panel cutout. |
...
| S005 | CTL | RESET | Tactile SMT Reset Switch | SKRPACE010 | TBD | TBD | TBD | RECHECK | Controller reset button. |
| S006 | ENC/Kbd | SW1-SW192 | DPDT 6-pin Momentary Keyboard Switch | TBD | TBD | TBD | TBD | RECHECK | Keyboard matrix switches. |
| S007 | ROT | SW_CFG | CTS 219-6LPSTR — 6-pos DIP switch, 2.54mm THT | 219-6LPSTR | TBD | TBD | TBD | RECHECK | Rotor configuration switches. |
| S008 | PM | BT_SW1_1-BT_SW1_6 | 2.8mm (0.110in) vertical PCB-mount male blade terminal; mates with Adafruit 4660 switch terminals for switch + RGB ring harness | TBD | TBD | TBD | TBD | RECHECK | Required because SW1 is now documented as a field-serviceable harnessed subassembly. Select six PCB tabs that match the switch's 2.8mm quick-connect format and retention/mechanical load requirements. |
